...
- If an entry for the crash doesn't exist, add it using the `crash_record_id` as key
- Then add a story entry as a list item: at minimum, it should have keys `url` and `title
    ```yaml
